...
const AddJob = () => {
  ...
  const {islodading,mutateAsync}= useMutation({
    mutationFn: async jobData=> {
      axios.post(`${import.meta.env.VITE_API_URL}/add-job`,jobData);
    },
    onSuccess:()=>{
